...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( IList<Mark?> cells)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Board() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( IList<Mark?> cells)  $default,) {final _that = this;
switch (_that) {
case _Board():
return $default(_that.cells);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( IList<Mark?> cells)?  $default,) {final _that = this;
switch (_that) {
case _Board() when $default != null:
return $default(_that.cells);case _:
  return null;
...
class _Board extends Board {
  const _Board(this.cells): super._();
  

@override final  IList<Mark?> cells;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Board&&const DeepCollectionEquality().equals(other.cells, cells));
}
