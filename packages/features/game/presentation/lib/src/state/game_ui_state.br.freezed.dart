...
mixin _$GameUiState {
 ...
 Game get game; bool get isCpuThinking;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GameUiState&&(identical(other.game, game) || other.game == game)&&(identical(other.isCpuThinking, isCpuThinking) || other.isCpuThinking == isCpuThinking));
}


@override
int get hashCode => Object.hash(runtimeType,game,isCpuThinking);

@override
String toString() {
  return 'GameUiState(game: $game, isCpuThinking: $isCpuThinking)';
}
...
/// Create a copy of GameUiState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? game = null,Object? isCpuThinking = null,}) {
  return _then(_self.copyWith(
game: null == game ? _self.game : game // ignore: cast_nullable_to_non_nullable
as Game,isCpuThinking: null == isCpuThinking ? _self.isCpuThinking : isCpuThinking // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of GameUiState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Game game,  bool isCpuThinking)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GameUiState() when $default != null:
return $default(_that.game,_that.isCpuThinking);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Game game,  bool isCpuThinking)  $default,) {final _that = this;
switch (_that) {
case _GameUiState():
return $default(_that.game,_that.isCpuThinking);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Game game,  bool isCpuThinking)?  $default,) {final _that = this;
switch (_that) {
case _GameUiState() when $default != null:
return $default(_that.game,_that.isCpuThinking);case _:
  return null;
...
class _GameUiState extends GameUiState {
  const _GameUiState({required this.game, this.isCpuThinking = false}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GameUiState&&(identical(other.game, game) || other.game == game)&&(identical(other.isCpuThinking, isCpuThinking) || other.isCpuThinking == isCpuThinking));
}
...
/// Create a copy of GameUiState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? game = null,Object? isCpuThinking = null,}) {
